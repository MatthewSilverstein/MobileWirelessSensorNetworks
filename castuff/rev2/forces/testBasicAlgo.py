...
def test2():
	...
	maxMoves = 200
	grid = Grid()
	sensors = initSensors3(rc, rs, kcover, kdegree, damp, cdistance, maxMoves)
...
def initSensors3(rc, rs, kcover, kdegree, damp, cdistance, maxMoves):
	sensors = []
	for i in range(15):
		for j in range(15):
			sensors.append(Sensor(rc, rs, kcover, kdegree, damp, cdistance, maxMoves, i, j))
	return sensors
